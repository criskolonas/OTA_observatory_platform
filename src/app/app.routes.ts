...
export const routes: Routes = [
  ...
  },
  {
    path: 'explore-map',
    loadChildren: () =>
      import('./explore-map/explore-map.module').then(
        (m) => m.ExploreMapModule,
      ),
    canActivate: [AuthGuard],
  },
  ...
  {
    path: 'prefecture/:id',
    component: PrefectureReportComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'features',
    component: OtaFeaturesComponent,
    canActivate: [AuthGuard],
  },
  {
    path: 'features/:id',
    component: OtaFeatureDetailsComponent,
    canActivate: [AuthGuard],
  },
];
